...
//media
const VoiceNoteXeon = JSON.parse(fs.readFileSync('./kurodenshi/database/xeonvn.json'))
const StickerXeon = JSON.parse(fs.readFileSync('./kurodenshi/database/xeonsticker.json'))
const ImageXeon = JSON.parse(fs.readFileSync('./kurodenshi/database/xeonimage.json'))
const VideoXeon = JSON.parse(fs.readFileSync('./kurodenshi/database/xeonvideo.json'))
const DocXeon = JSON.parse(fs.readFileSync('./kurodenshi/database/doc.json'))
const ZipXeon = JSON.parse(fs.readFileSync('./kurodenshi/database/zip.json'))
const ApkXeon = JSON.parse(fs.readFileSync('./kurodenshi/database/apk.json'))
...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
    try {
       ...
       //group
        ...
        //theme sticker reply
        const XeonStickWait = () => {
        let XeonStikRep = fs.readFileSync('./kurodenshi/theme/sticker_reply/wait.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickAdmin = () => {
        let XeonStikRep = fs.readFileSync('./kurodenshi/theme/sticker_reply/admin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickBotAdmin = () => {
        let XeonStikRep = fs.readFileSync('./kurodenshi/theme/sticker_reply/botadmin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickOwner = () => {
        let XeonStikRep = fs.readFileSync('./kurodenshi/theme/sticker_reply/owner.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickGroup = () => {
        let XeonStikRep = fs.readFileSync('./kurodenshi/theme/sticker_reply/group.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickPrivate = () => {
        let XeonStikRep = fs.readFileSync('./kurodenshi/theme/sticker_reply/private.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        //premium
    ...
    return await XeonBotInc.relayMessage(chatId, generate.message, { messageId: generate.key.id })
                ...
                XeonBotInc.sendMessage(m.chat, {
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: ownername,
                            previewType: "PHOTO",
                            thumbnail: fs.readFileSync('./kurodenshi/theme/cheemspic.jpg'),
                            sourceUrl: wagc
                        }
                    },
                    text: teks
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6285748600473-1616169743@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":botname, "h": wm,'seconds': '359996400', 'caption': `${pushname}`, 'jpegThumbnail': thumb}}}
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: wm,jpegThumbnail: thumb}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': ownername, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername}\nitem1.TEL;waid=916909137213:916909137213\nitem1.X-ABLabel:Mobile\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./kurodenshi/theme/cheemspic.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
	    const frpayment = {
	key: {
...
XeonBotInc.sendMessage(`${ownernumber}@s.whatsapp.net`,{text: `Hi Owner! wa.me/${sender.split("@")[0]} Detected Having Sent Virtex ${isGroup?`in ${groupName}`:''}`})
 ...
 if (db.data.chats[m.chat].antibot) {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].image && iskurodenshi) {
    if(iskurodenshi === "imageMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].antivideo && iskurodenshi) {
    if(iskurodenshi === "videoMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].antisticker && iskurodenshi) {
    if(iskurodenshi === "stickerMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].antiaudio && iskurodenshi) {
    if(iskurodenshi === "audioMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
       ...
       if (db.data.chats[m.chat].antipoll && iskurodenshi) {
    if(iskurodenshi === "pollCreationMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
       ...
       if (db.data.chats[m.chat].antilocation && iskurodenshi) {
    if(iskurodenshi === "locationMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
       ...
       if (db.data.chats[m.chat].antidocument && iskurodenshi) {
    if(iskurodenshi === "documentMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
      ...
      if (db.data.chats[m.chat].anticontact && iskurodenshi) {
    if(iskurodenshi === "contactMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
        } else {
...
let audiobuffy = fs.readFileSync(`./kurodenshi/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./kurodenshi/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./kurodenshi/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./kurodenshi/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kurodenshi/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kurodenshi/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kurodenshi/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
...
break            
            ...
            case 'sim': {
                ...
                await fsx.copy(delb, './kurodenshi/theme/cheemspic.jpg')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
            ...
            case 'sgm': {
                if (!XeonTheCreator) return XeonStickOwner()
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                await fsx.copy(delb, './kurodenshi/theme/Cheems-bot.mp4')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
VideoXeon.push(q)
await fsx.copy(delb, `./kurodenshi/video/${q}.mp4`)
fs.writeFileSync('./kurodenshi/database/xeonvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./kurodenshi/database/xeonvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(`./kurodenshi/video/${q}.mp4`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ImageXeon.push(q)
await fsx.copy(delb, `./kurodenshi/image/${q}.jpg`)
fs.writeFileSync('./kurodenshi/database/xeonimage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./kurodenshi/database/xeonimage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(`./kurodenshi/image/${q}.jpg`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
StickerXeon.push(q)
await fsx.copy(delb, `./kurodenshi/sticker/${q}.webp`)
fs.writeFileSync('./kurodenshi/database/xeonsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./kurodenshi/database/xeonsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(`./kurodenshi/sticker/${q}.webp`)
...
await fsx.copy(delb, `./kurodenshi/audio/${q}.mp3`)
fs.writeFileSync('./kurodenshi/database/xeonvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./kurodenshi/database/xeonvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(`./kurodenshi/audio/${q}.mp3`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./kurodenshi/zip/${teks}.zip`)
fs.writeFileSync('./kurodenshi/database/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./kurodenshi/database/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./kurodenshi/zip/${teks}.zip`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./kurodenshi/apk/${teks}.apk`)
fs.writeFileSync('./kurodenshi/database/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./kurodenshi/database/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./kurodenshi/apk/${teks}.apk`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
DocXeon.push(teks)
await fsx.copy(delb, `./kurodenshi/doc/${teks}.pdf`)
fs.writeFileSync('./kurodenshi/database/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./kurodenshi/database/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./kurodenshi/doc/${teks}.pdf`)
...
break
  case 'totalfeature':
        ...
        break
            ...
            let me = m.sender
            let xmenu_oh = `
*hello friend nice to meet you, i am *xCez Bot*
...
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./kurodenshi/theme/cheemspic.jpg'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./kurodenshi/theme/Cheems-bot.mp4'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", "Halo, Akun Whatsapp Saya diblokir Saya Maaf Saya Telah Menginstal Aplikasi Pihak Ketiga Secara Tidak Sengaja. Harap Buka Blokir Akun Saya Sesegera Mungkin. Terimakasih")
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
